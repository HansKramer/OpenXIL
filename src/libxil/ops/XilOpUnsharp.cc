...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)XilOpUnsharp.cc	1.18\t00/03/10  "
...
class XilOpUnsharp : public XilOpAreaKernel {
public:
...
protected:
                  XilOpUnsharp(XilOpNumber op_num);
    virtual       ~XilOpUnsharp();
...
//
XilOp*
XilOpUnsharp::create(char  function_name[],
                  void* args[],
                  int   argc)
{
    ...
    XilOpUnsharp* op = new XilOpUnsharp(opnum);
    if(op == NULL) {
...
XilOpUnsharp::XilOpUnsharp(XilOpNumber op_num) : XilOpAreaKernel(op_num) { }

XilOpUnsharp::~XilOpUnsharp() { }
