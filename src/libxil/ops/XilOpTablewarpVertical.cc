...
//------------------------------------------------------------------------
//
//  File:	XilOpTablewarpVertical.cc
//  Project:	XIL
//  Revision:	1.14
...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)XilOpTablewarpVertical.cc	1.14\t00/03/10  "

#include "XilOpGeometricWarp.hh"

class XilOpTablewarpVertical : public XilOpGeometricWarp {
public:
    static XilOp* create(char* function_name,
                         void* args[],
                         int count);
    
                  XilOpTablewarpVertical(XilOpNumber            op_num,
                                         XilImage*              src_image,
                                         XilImage*              dst_image,
    ...
    virtual              ~XilOpTablewarpVertical()
    {
    }
};
...
xili_tablewarp_op_create_func(XilOpNumber            op_num,
                              ...
                              XilInterpolationTable* v_table)
{
    return new XilOpTablewarpVertical(op_num, src_image, dst_image,
                                      type, h_table, v_table);
}

XilOp*
XilOpTablewarpVertical::create(char  function_name[],
                               void* args[],
                               int   )
{
