...
//------------------------------------------------------------------------
//
//  File:	XilOpTablewarpHorizontal.cc
//  Project:	XIL
//  Revision:	1.14
//  Last Mod:	10:07:37, 03/10/00
//
//  Description:
//	
//	
...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)XilOpTablewarpHorizontal.cc	1.14\t00/03/10  "

#include "XilOpGeometricWarp.hh"

class XilOpTablewarpHorizontal : public XilOpGeometricWarp {
public:
    static XilOp* create(char* function_name,
                         void* args[],
                         int count);
    
                  XilOpTablewarpHorizontal(XilOpNumber            op_num,
                                           XilImage*              src_image,
                                           XilImage*              dst_image,
    ...
    virtual              ~XilOpTablewarpHorizontal()
    {
    }
};
...
xili_tablewarp_op_create_func(XilOpNumber            op_num,
                              ...
                              XilInterpolationTable* v_table)
{
    return new XilOpTablewarpHorizontal(op_num, src_image, dst_image,
                                        type, h_table, v_table);
}

XilOp*
XilOpTablewarpHorizontal::create(char  function_name[],
                                 void* args[],
                                 int   )
{
