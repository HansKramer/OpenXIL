...
/*
 * Unsharp masking global options
 */
typedef enum __XilUnsharpMasking {
    XIL_UNSHARP_MT       = 1,
    XIL_UNSHARP_EDGE_OPT = 2,
    XIL_UNSHARP_ZAMBONI  = 4,
    XIL_UNSHARP_INTEGER  = 8,
    XIL_UNSHARP_HYPER    = 16
} XilUnsharpMasking;
                                                                                
typedef enum __XilUnsharpMaskingType {
    XIL_UNSHARP_REGULAR  = 0,
    XIL_UNSHARP_INVERTED = 1,
    XIL_UNSHARP_TRIANGLE = 2
} XilUnsharpMaskingType;
