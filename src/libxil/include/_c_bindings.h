...
void
xil_unsharp(XilImage src, XilImage dst, unsigned int size, float alpha, float beta, float gamma);
                                                                                                        
void
xil_unsharp_ic(XilImage src, XilImage dst, unsigned int size, float alpha, float beta, float gamma, XilUnsharpMaskingType type, int window, int level);
