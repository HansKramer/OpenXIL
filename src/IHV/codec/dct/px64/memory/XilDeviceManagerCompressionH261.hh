...
//------------------------------------------------------------------------
//
//  File:       XilDeviceManagerCompressionH261.hh
//  Project:    XIL
//  Revision:   1.5
//  Last Mod:   10:23:14, 03/10/00
//
//  Description:
//
...
//    COPYRIGHT
//------------------------------------------------------------------------
#pragma ident   "@(#)XilDeviceManagerCompressionH261.hh	1.5\t00/03/10  "


#ifndef _XIL_DEVICE_MANAGER_COMPRESSION_H261_HH 
#define _XIL_DEVICE_MANAGER_COMPRESSION_H261_HH 

#include <xil/xilGPI.hh>
#include "Ycc2RgbConverter.hh"
#include "XiliOrderedDitherLut.hh"

class XilDeviceManagerCompressionH261 : public XilDeviceManagerCompression {
public:
...
#endif // _XIL_DEVICE_MANAGER_COMPRESSION_H261_HH 
