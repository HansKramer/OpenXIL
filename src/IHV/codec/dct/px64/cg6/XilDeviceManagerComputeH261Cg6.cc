...
//------------------------------------------------------------------------
//
//  File:       XilDeviceManagerComputeH261Cg6.cc
//  Project:    XIL
//  Revision:   1.3
//  Last Mod:   10:15:08, 03/10/00
//
//  Description:
//
...
//    COPYRIGHT
//------------------------------------------------------------------------
#pragma ident   "@(#)XilDeviceManagerComputeH261Cg6.cc	1.3\t00/03/10  "

#include "XilDeviceManagerComputeH261Cg6.hh"

//
// Constructor - Register codec-specific attributes
//
XilDeviceManagerComputeH261Cg6::XilDeviceManagerComputeH261Cg6()
{
};
                                ...
                                unsigned int* devhandler_gpi_minor)
{
    ...
    return new XilDeviceManagerComputeH261Cg6();
}
 
const char*
XilDeviceManagerComputeH261Cg6::getDeviceName()
{
    return "H261Cg6";
}
 
XilStatus
XilDeviceManagerComputeH261Cg6::describeMembers()
{
    ...
    func_info->setFunction((XilComputeFunctionPtr)
        &XilDeviceManagerComputeH261Cg6::decompressDither8Cg6,
        "display_SUNWcg6(color_convert;8(decompress_H261()))" );
    ...
    func_info->setFunction((XilComputeFunctionPtr)
        &XilDeviceManagerComputeH261Cg6::decompressDither8Cg6,
        "display_SUNWcg6(copy;8(color_convert;8(decompress_H261())))" );
    addFunction(func_info);
    func_info->destroy();
    ...
    func_info->setFunction((XilComputeFunctionPtr)
        &XilDeviceManagerComputeH261Cg6::decompressDither8Cg6,
        "display_SUNWcg6(scale;8(color_convert;8(decompress_H261())))" );
    addFunction(func_info);
    func_info->destroy();
    ...
    func_info->setFunction((XilComputeFunctionPtr)
        &XilDeviceManagerComputeH261Cg6::decompressDither8Cg6,
        "display_SUNWcg6(copy;8(scale;8((color_convert;8(decompress_H261()))))" );
    addFunction(func_info);
    func_info->destroy();
