...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident        "@(#)TablewarpVerticalBicubic.cc	1.18\t00/03/10  "
...
XilStatus
XilDeviceManagerComputeBIT::TablewarpVerticalBicubic(XilOp*       op,
                                                     unsigned     ,
                                                     XilRoi*      roi,
                                                     XilBoxList*  bl)
{
    ...
    for(unsigned int b=0; b<nbands; b++) {
        ...
        while(rl.getNext(&x, &y, &xsize, &ysize)) {
		    ...
		    Xil_unsigned8* src_scanline   = src_data + sytable[isy] -
                    ...
                    //
                    xili_interp_cubic_bit_vertical(src_scanline,
                                                   src_scanline_stride,
                                                   src_bit,
                                                   fracy,
                                                   dst_scanline,
