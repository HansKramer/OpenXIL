...
#pragma ident        "@(#)TablewarpNearest.cc	1.13\t00/03/10  "
...
static XilStatus tablewarp_nearest(XilBoxList*  bl, TablewarpData td);
...
XilStatus
XilDeviceManagerComputeBIT::TablewarpNearest(XilOp*       op,
                                             unsigned     ,
                                             XilRoi*      roi,
                                             XilBoxList*  bl)
{
            ...
            for(unsigned j=dst_ystart; j<dst_yend; j++) {
                ...
                for(unsigned int i=dst_xstart; i<dst_xend;  i++) {
                    ...
                    int idy = j + src_to_box_y +
                        xili_tablewarp_offset_int(*warp_pixel_b1);
