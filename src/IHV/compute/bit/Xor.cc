...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)Xor.cc	1.7\t00/03/10  "
...
XilStatus
XilDeviceManagerComputeBIT::Xor(XilOp*       op,
                                unsigned     op_count,
                                XilRoi*      roi,
                                XilBoxList*  bl)
{
	...
	for(int b=0; b<nbands; b++) {
		...
		xili_bit_xor(src1_scanline, src2_scanline, dest_scanline,
                             ci.xsize,
...
void
XilDeviceManagerComputeBIT::xili_bit_xor(Xil_unsigned8* src1,
					 Xil_unsigned8* src2,
					 Xil_unsigned8* dest,
					 int            width,
					 int            src1_offset,
