...
XilStatus
XilDeviceManagerComputeBIT::TablewarpVerticalBilinear(XilOp*       op,
                                                      unsigned     ,
                                                      XilRoi*      roi,
                                                      XilBoxList*  bl)
{
        ...
        while(rl.getNext(&x, &y, &xsize, &ysize)) {
		    ...
		    Xil_unsigned8* src_scanline_1 =
                    ...
                    float p00 = (float)XIL_BMAP_TST(src_scanline,
                                                    src_bit);
                    float p01 = (float)XIL_BMAP_TST(src_scanline_1,
                                                    src_bit);

		    //
		    //  Do linear interpolation - fracx == 0.0F
		    //
                    float p;
		    XILI_GEOM_BLEND(p, p00,  p01, fracy);
