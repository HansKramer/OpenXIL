...
static XilStatus tablewarp_h_nearest(XilBoxList*  bl, TablewarpData td);
...
XilStatus
XilDeviceManagerComputeBIT::TablewarpHorizontalNearest(XilOp*       op,
                                                       unsigned     ,
                                                       XilRoi*      roi,
                                                       XilBoxList*  bl)
{
