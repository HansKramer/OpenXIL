...
// COPYRIGHT
//------------------------------------------------------------------------
#pragma ident  "@(#)AffineBilinear.cc	1.29\t00/03/10  "
...
XilStatus
XilDeviceManagerComputeBYTE::AffineBilinear(XilOp*       op,
					    unsigned       ,
					    XilRoi*      roi,
					    XilBoxList*  bl)
{
...
XilStatus
XilDeviceManagerComputeBYTE::affineBilinear(XilBoxList* bl,
					    AffineData  ad)
{
    XilOp*    op  = ad.op;
