...
// COPYRIGHT
//------------------------------------------------------------------------
#pragma ident  "@(#)AffineBicubic.cc	1.27\t00/03/10  "
...
XilStatus
XilDeviceManagerComputeBYTE::AffineBicubic(XilOp*       op,
					   unsigned     ,
					   XilRoi*      roi,
					   XilBoxList*  bl)
{
...
XilStatus
XilDeviceManagerComputeBYTE::affineBicubic(XilBoxList* bl,
					   AffineData  ad)
{
    XilOp*    op  = ad.op;
...
xili_affine_pixel_sequential_BC(AffineData affine_data)
{
    ...
    Xil_unsigned8* src_data_max = src_data +
...
fprintf(stderr, "src x=%d, y=%d\n", isx, isy);                    
                    ...
                    //
                    XILI_INTERP_BICUBIC_BYTE(src_pixel_clip,
                                             src_sstride,
                                             src_pstride,
                                             fracx, fracy,
                                             dst_pixel);
