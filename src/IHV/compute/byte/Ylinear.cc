...
void
ylinear_to_rgblinear(Xil_unsigned8 *i_ptr,
                     Xil_unsigned8 *o_ptr,
                     unsigned int count,
...
void
ylinear_to_photoycc(Xil_unsigned8 *i_ptr,
                    Xil_unsigned8 *o_ptr,
                    unsigned int count,
                    unsigned int src_pixel_stride,
                    unsigned int dst_pixel_stride)
{
    ...
    for (unsigned int i = 0; i < count; i++) {
      ...
      ylinear = _XILI_NORMALIZE_B(*(i_ptr));                   
                                    
      r = _XILI_L_TO_NL_1(ylinear);                       
                                    
      _XILI_QUANTIZE_PHOTO_B(r, 0.0, 0.0, o_ptr, o_ptr+1, o_ptr+2);
...
void
ylinear_to_ycc601(Xil_unsigned8 *i_ptr,
                  Xil_unsigned8 *o_ptr,
                  unsigned int count,
                  unsigned int src_pixel_stride,
                  unsigned int dst_pixel_stride)
...
void
ylinear_to_ycc709(Xil_unsigned8 *i_ptr,
                  Xil_unsigned8 *o_ptr,
                  unsigned int count,
                  unsigned int src_pixel_stride,
                  unsigned int dst_pixel_stride)
...
void
ylinear_to_cmy(Xil_unsigned8 *i_ptr,
               Xil_unsigned8 *o_ptr,
               unsigned int count,
               unsigned int src_pixel_stride,
               unsigned int dst_pixel_stride)
{
    ...
    for (unsigned int i = 0; i < count; i++) {
      *o_ptr = XIL_MAXBYTE - *(i_ptr) + XIL_MINBYTE;
      *(o_ptr + 1) = *o_ptr;               
      *(o_ptr + 2) = *o_ptr;              
...
void
ylinear_to_cmyk(Xil_unsigned8 *i_ptr,
                Xil_unsigned8 *o_ptr,
                unsigned int count,
                unsigned int src_pixel_stride,
                unsigned int dst_pixel_stride)
...
void
ylinear_to_y709(Xil_unsigned8 *i_ptr,
                   Xil_unsigned8 *o_ptr,
                   unsigned int count,
                   unsigned int src_pixel_stride,
                   unsigned int dst_pixel_stride)
{
    ...
    for (unsigned int i = 0; i < count; i++) {
      ...
      *o_ptr = _XILI_QUANTIZE_Y709_B(r7);                       
...
void
ylinear_to_y601(Xil_unsigned8 *i_ptr,
                Xil_unsigned8 *o_ptr,
                unsigned int count,
                unsigned int src_pixel_stride,
                unsigned int dst_pixel_stride)
{
    ...
    for (unsigned int i = 0; i < count; i++) {
      ...
      *o_ptr = _XILI_QUANTIZE_Y601_B(r7);                       
