...
//------------------------------------------------------------------------
//
//  File:	TablewarpHorizontalGeneral.cc
//  Project:	XIL
//  Revision:	1.26
//  Last Mod:	10:11:02, 03/10/00
//
//  Description:
//	
//	
...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)TablewarpHorizontalGeneral.cc	1.26\t00/03/10  "
...
//
static XilStatus tablewarp_h_general(XilBoxList*  bl, TablewarpData td);
...
XilStatus
XilDeviceManagerComputeBYTE::TablewarpHorizontalGeneral(XilOp*       op,
                                                        unsigned     ,
                                                        XilRoi*      roi,
                                                        XilBoxList*  bl)
{
    ...
    status = tablewarp_h_general(bl, td);
...
static
XilStatus
tablewarp_h_general(XilBoxList*  bl,
                    TablewarpData td)
{
    XilOp*    op   = td.op;
