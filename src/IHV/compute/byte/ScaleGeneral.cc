...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)ScaleGeneral.cc	1.6\t00/03/10  "
...
XilStatus
XilDeviceManagerComputeBYTE::ScaleGeneral(XilOp*       op,
					  unsigned     ,
					  XilRoi*      roi,
					  XilBoxList*  bl)
{
    ...
    //
    // get the interpolation tables
    //
    XilInterpolationTable* htable;
    XilInterpolationTable* vtable;

    op->getParam(3, (void**)&htable);
    op->getParam(4, (void**)&vtable);
