...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)AddConst.cc	1.9\t00/03/10  "

#include "XilDeviceManagerComputeBYTE.hh"
#include "ComputeInfo.hh"

XilStatus
XilDeviceManagerComputeBYTE::AddConstPreprocess(XilOp*        op,
                                                unsigned      ,
                                                XilRoi*       ,
                                                void**        compute_data,
                                                unsigned int* )
...
XilStatus
XilDeviceManagerComputeBYTE::AddConstPostprocess(XilOp*       op,
                                                 void*        compute_data)
{
...
XilStatus
XilDeviceManagerComputeBYTE::AddConst(XilOp*       op,
				      unsigned     op_count,
				      XilRoi*      roi,
				      XilBoxList*  bl)
{
    ...
    if(tables == NULL) {
        ...
        op->getParam(1, (void**)&add_consts);
        
        while(ci.hasMoreInfo()) {
            Xil_signed16*  consts = add_consts;
