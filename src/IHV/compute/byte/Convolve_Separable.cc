...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)Convolve_Separable.cc	1.18\t00/03/10  "
...
static XilStatus
ConvolveSep(Xil_unsigned8* dest_data,
...
XilStatus
XilDeviceManagerComputeBYTE::Convolve_SeparablePreprocess(XilOp*        op,
                                                          unsigned      ,
                                                          XilRoi*       ,
                                                          void**        ,
                                                          unsigned int* )
...
XilStatus
XilDeviceManagerComputeBYTE::Convolve_Separable(XilOp*       op,
                                                unsigned     ,
                                                XilRoi*      roi,
                                                XilBoxList*  bl)
{
            ...
            int kheight)
{
    ...
    for( int b = 0; b < nbands; b++ ) {
        ...
        if( kwidth == 5 && kheight == 5 ) {
            ...
            //
            Xil_unsigned8 *src = srcptr;
            Xil_unsigned8 *dst = dstptr;
            Xil_unsigned8 *tmp = srcptr;
            ...
            while( kh-- ) {
                for( j = 0; j < src1_xsize; j++ ) {
                    fsum  = _XILI_B2F(*src) * kx0;  src += src1_pixel_stride;
                    fsum += _XILI_B2F(*src) * kx1;  src += src1_pixel_stride;
                    fsum += _XILI_B2F(*src) * kx2;  src += src1_pixel_stride;
                    fsum += _XILI_B2F(*src) * kx3;  src += src1_pixel_stride;
                    fsum += _XILI_B2F(*src) * kx4;
