...
// COPYRIGHT
//------------------------------------------------------------------------
#pragma ident  "@(#)AffineNearest.cc	1.31\t00/03/10  "
...
XilStatus
XilDeviceManagerComputeBYTE::AffineNearest(XilOp*       op,
                                           unsigned        ,
                                           XilRoi*      roi,
                                           XilBoxList*  bl)
{
...
XilStatus
XilDeviceManagerComputeBYTE::affineNearest(XilBoxList* bl,
                                           AffineData  ad)
{
    XilOp*     op = ad.op;
...
fprintf (stderr, "src x=%d, y=%d\n", isx, isy);                    
                ...
                for(unsigned int i = dst_scan_start; i <= dst_scan_end; i++) {
                    ...
                    Xil_unsigned8* src_band = xili_srcbox_clip(nearest_pixel,
                                                               src_data,
                                                               src_data_max);
