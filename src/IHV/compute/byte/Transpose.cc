...
//  Project:	XIL
//  Revision:	1.16
//  Last Mod:	10:10:24, 03/10/00
//
//  Description:
//
//
//  Transpose() retrieves byte src and dst images, a fliptype and
...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)Transpose.cc	1.16\t00/03/10  "

#include "XilDeviceManagerComputeBYTE.hh"
#include "ComputeInfo.hh"

XilStatus
XilDeviceManagerComputeBYTE::Transpose(XilOp* op,
				       unsigned ,
				       XilRoi*      roi,
				       XilBoxList*  bl)
{
	...
	if((src_storage.isType(XIL_PIXEL_SEQUENTIAL)) &&
	   (dst_storage.isType(XIL_PIXEL_SEQUENTIAL))) {
	    ...
	    Xil_unsigned8*  dst_scanline;	// ptr to current scanline 
