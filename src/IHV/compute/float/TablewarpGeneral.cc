...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)TablewarpGeneral.cc	1.17\t00/03/10  "
...
XilStatus
XilDeviceManagerComputeFLOAT::TablewarpGeneral(XilOp*       op,
					      unsigned     ,
					      XilRoi*      roi,
					      XilBoxList*  bl)
{
    ...
    while(rl.getNext(&x, &y, &xsize, &ysize)) {
        ...
        for(unsigned j=dst_ystart; j<dst_yend; j++) {
            ...
            for(unsigned int i=dst_xstart; i<dst_xend;  i++) {
                ...
                do {
                    XILI_INTERP_GENERAL_FLOAT(pixel_addr,
                                              src_scanline_stride,
                                              src_pixel_stride,
                                              v_ptr, h_ptr,
                                              v_size, h_size,
