...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)AffineGeneral.cc	1.19\t00/03/10  "
...
XilStatus
XilDeviceManagerComputeFLOAT::AffineGeneral(XilOp*       op,
                                            unsigned     ,
                                            XilRoi*      roi,
                                            XilBoxList*  bl)
{
...
XilStatus
XilDeviceManagerComputeFLOAT::affineGeneral(XilBoxList* bl,
                                            AffineData  ad)
{
    XilOp*    op  = ad.op;
...
xili_affine_pixel_sequential_GL(AffineData affine_data)
{
    ...
    Xil_float32* src_data_min = src_data -
                                (v_key*src_sstride + h_key*src_pstride);
    Xil_float32* src_data_max = src_data_min +
...
fprintf(stderr, "src x=%d, y=%d\n", isx, isy);                    
                    ...
                    //
                    XILI_INTERP_GENERAL_FLOAT(src_pixel_clip,
                                              src_sstride,
                                              src_pstride,
                                              v_ptr, h_ptr,
                                              v_size, h_size,
...
fprintf(stderr, "src x=%d, y=%d\n", isx, isy);
                    ...
                    do {
                        ...
                        //  Do general interpolation...
                        //
                        XILI_INTERP_GENERAL_FLOAT(src_band,
                                                  src_sstride,
                                                  src_pstride,
                                                  v_ptr, h_ptr,
                                                  v_size, h_size,
