...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)AffineBicubic.cc	1.22\t00/03/10  "
...
XilStatus
XilDeviceManagerComputeFLOAT::AffineBicubic(XilOp*       op,
                                            unsigned     ,
                                            XilRoi*      roi,
                                            XilBoxList*  bl)
{
...
XilStatus
XilDeviceManagerComputeFLOAT::affineBicubic(XilBoxList* bl,
                                            AffineData  ad)
{
    XilOp*    op  = ad.op;
...
fprintf(stderr, "src x=%d, y=%d\n", isx, isy);                    
                    ...
                    //
                    XILI_INTERP_BICUBIC_FLOAT(src_pixel_clip,
                                              src_sstride,
                                              src_pstride,
                                              fracx, fracy,
                                              dst_pixel);
