...
XilStatus
XilDeviceManagerComputeFLOAT::ScaleBilinear(XilOp*       op,
					    unsigned        ,
					    XilRoi*      roi,
					    XilBoxList*  bl)
{
...
XilStatus
XilDeviceManagerComputeFLOAT::scale_2x_BL(XilBoxList* bl,
					  AffineData  ad)
{
    //
...
XilStatus
XilDeviceManagerComputeFLOAT::scale_05x_BL(XilBoxList* bl,
					   AffineData  ad)
{
    //
