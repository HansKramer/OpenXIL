...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)Blend.cc	1.10\t00/03/10  "

#include "XilDeviceManagerComputeFLOAT.hh"
#include "ComputeInfo.hh"

XilStatus
XilDeviceManagerComputeFLOAT::Blenda1(XilOp*       op,
				      unsigned     op_count,
				      XilRoi*      roi,
				      XilBoxList*  bl)

{
           ...
           (ci.destStorage.isType(XIL_PIXEL_SEQUENTIAL)))
	{
	    ...
	    Xil_float32*   src1_scanline        = (Xil_float32*) ci.src1Data;
            Xil_float32*   src2_scanline        = (Xil_float32*) ci.src2Data;
            ...
            if(nbands == 1) {
                for(y=ci.ysize; y>0; y--) {
                    ...
                    Xil_float32*  src2 = src2_scanline;
                ...
                for(y=ci.ysize; y>0; y--) {
                    ...
                    Xil_float32*  src2_pixel = src2_scanline;
                    Xil_float32*  dest_pixel = dest_scanline;

                    for(x=0, o=x+srcA_offset; x<ci.xsize; x++, o++) {
                        Xil_float32*  src1 = src1_pixel;
                        Xil_float32*  src2 = src2_pixel;
	    ...
	    for(int band=0; band<nbands; band++) { 
                ...
                //  The input images.
                //
                Xil_float32*   src1_scanline        =
                    (Xil_float32*)ci.getSrc1Data(band);
                Xil_float32*   src2_scanline        =
                    (Xil_float32*)ci.getSrc2Data(band);
                Xil_float32*   dest_scanline        =
                    (Xil_float32*)ci.getDestData(band);
...
XilStatus
XilDeviceManagerComputeFLOAT::Blenda8(XilOp*       op,
                                      unsigned     op_count,
                                      XilRoi*      roi,
                                      XilBoxList*  bl)
           ...
           (ci.destStorage.isType(XIL_PIXEL_SEQUENTIAL)))
	{
	    ...
	    for(int band=0; band<nbands; band++) { 
                ...
                Xil_float32*   src1_scanline        = (Xil_float32*)
                    ci.getSrc1Data(band);
                Xil_float32*   src2_scanline        = (Xil_float32*)
                    ci.getSrc2Data(band);
...
XilStatus
XilDeviceManagerComputeFLOAT::Blenda16(XilOp*       op,
				       unsigned     op_count,
				       XilRoi*      roi,
				       XilBoxList*  bl)
...
XilStatus
XilDeviceManagerComputeFLOAT::Blendaf32(XilOp*       op,
					unsigned     op_count,
					XilRoi*      roi,
					XilBoxList*  bl)

{
           ...
           (ci.destStorage.isType(XIL_PIXEL_SEQUENTIAL)))
	{
            ...
            //  The Alpha image.
            //
            Xil_float32*  srcA_scanline        = ci.src3Data;
            unsigned int  srcA_scanline_stride = ci.src3ScanlineStride;
            unsigned int  srcA_pixel_stride    = ci.src3PixelStride;
	    ...
	    Xil_float32*  src1_scanline        = ci.src1Data;
            Xil_float32*  src2_scanline        = ci.src2Data;
