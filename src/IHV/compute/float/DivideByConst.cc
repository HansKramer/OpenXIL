...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)DivideByConst.cc	1.5\t00/03/10  "

#include "XilDeviceManagerComputeFLOAT.hh"
#include "ComputeInfo.hh"

XilStatus
XilDeviceManagerComputeFLOAT::DivideByConst(XilOp*       op,
                                            unsigned     op_count,
                                            XilRoi*      roi,
                                            XilBoxList*  bl)
{
    ...
    //
    //  The XIL core checks the constants for 0.0
    //
    float* op_constants;
