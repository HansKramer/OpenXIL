...
XilStatus
XilDeviceManagerComputeFLOAT::AffineNearest(XilOp*       op,
                                            unsigned        ,
                                            XilRoi*      roi,
                                            XilBoxList*  bl)
{
...
XilStatus
XilDeviceManagerComputeFLOAT::affineNearest(XilBoxList* bl,
                                            AffineData  ad)
{
    XilOp*     op = ad.op;
...
fprintf (stderr, "src x=%d, y=%d\n", isx, isy);
                ...
                for(unsigned int i = dst_scan_start; i <= dst_scan_end; i++) {
                    ...
                    Xil_float32*   src_band = xili_srcbox_clip(nearest_pixel,
                                                   src_data,
                                                   src_data_max);
