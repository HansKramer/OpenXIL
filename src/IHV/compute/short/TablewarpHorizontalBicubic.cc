...
//------------------------------------------------------------------------
//
//  File:	TablewarpHorizontalBicubic.cc
//  Project:	XIL
//  Revision:	1.18
//  Last Mod:	10:12:31, 03/10/00
//
//  Description:
//	
//	
...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)TablewarpHorizontalBicubic.cc	1.18\t00/03/10  "
...
//
static XilStatus tablewarp_h_bicubic(XilBoxList*  bl, TablewarpData td);
...
XilStatus
XilDeviceManagerComputeSHORT::TablewarpHorizontalBicubic(XilOp*       op,
                                                        unsigned     ,
                                                        XilRoi*      roi,
                                                        XilBoxList*  bl)
{
    ...
    status = tablewarp_h_bicubic(bl, td);
...
static
XilStatus
tablewarp_h_bicubic(XilBoxList*  bl,
                    TablewarpData td)
{
    XilOp*    op   = td.op;
