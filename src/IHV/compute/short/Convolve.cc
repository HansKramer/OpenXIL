...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)Convolve.cc	1.13\t00/03/10  "
...
static
XilStatus
xili_convolve_square_opt_1(Xil_signed16* dst_data,
...
static
XilStatus
xili_convolve_3x3_opt_1(Xil_signed16* dst_data,
                        unsigned int  dst_sstride,
                        unsigned int  dst_pstride,
                        Xil_signed16* src_data,
                        unsigned int  src_sstride,
...
XilStatus
XilDeviceManagerComputeSHORT::Convolve(XilOp*       op,
				      unsigned     ,
				      XilRoi*      roi,
				      XilBoxList*  bl)
{
                    ...
                    while(rl.getNext(&x, &y, &xsize, &ysize)) {
                        ...
                        do {
                            ...
                            do {
                                float  fsum                = 0.0F;
                                float* kptr                = kdata;
                                Xil_signed16* sptr_save    = kernel_pixel;
                                Xil_signed16* sptr         = sptr_save;
                    ...
                    while(rl.getNext(&x, &y, &xsize, &ysize)) {
                        ...
                        do {
                            ...
                            do {
                                ...
                                for(unsigned int kh = kheight; kh != 0; kh--) {
                                    for(unsigned int kw = kwidth; kw != 0; kw--) {
                                        fsum0 += (float)(*sptr)     * *kptr;
                                        fsum1 += (float)(*(sptr+1)) * *kptr;
                                        fsum2 += (float)(*(sptr+2)) * *kptr;
                                ...
                                *dest_pixel     = _XILI_ROUND_S16(fsum0);
                                *(dest_pixel+1) = _XILI_ROUND_S16(fsum1);
                                *(dest_pixel+2) = _XILI_ROUND_S16(fsum2);
                    ...
                    while(rl.getNext(&x, &y, &xsize, &ysize)) {
                        ...
                        do {
                            ...
                            do {
                                ...
                                Xil_signed16* dest_band   = dest_pixel;
                                Xil_signed16* kernel_band = kernel_pixel;
                                unsigned int  band_count  = nbands;

                                do {
                                    float  fsum                 = 0.0F;
                                    float* kptr                 = kdata;
                                    Xil_signed16* sptr_save     = kernel_band;
                                    Xil_signed16* sptr          = sptr_save;
                                    unsigned int   src1_sstride = src1_scanline_stride;
                                    unsigned int   src1_pstride = src1_pixel_stride;
                                    ...
                                    *dest_band = _XILI_ROUND_S16(fsum);
                        ...
                        float*        kdata)
{
    ...
    for(y=ycount; y!=0; y--) {
        ...
        //  Pass 2
        //
        inA= (float)(src_data[0]);

        temp3 = inA * k33;
        r1a  = temp3;

        inA= (float)(src_data[srow1]);
        ...
        while(1) {
            ...
            dst_data[0]= _XILI_ROUND_S16(r1a);
            ...
            dst_data[drow1]= _XILI_ROUND_S16(r2a);
            ...
            dst_data[drow2]= _XILI_ROUND_S16(r3a);
            ...
            dst_data[drow3]= _XILI_ROUND_S16(r4a);
            ...
            dst_data[0]= _XILI_ROUND_S16(r1b);
            ...
            dst_data[drow1]= _XILI_ROUND_S16(r2b);
            ...
            dst_data[drow2]= _XILI_ROUND_S16(r3b);
            ...
            dst_data[drow3]= _XILI_ROUND_S16(r4b);
            ...
            dst_data[0]= _XILI_ROUND_S16(r1c);
            ...
            dst_data[drow1]= _XILI_ROUND_S16(r2c);
            ...
            dst_data[drow2]= _XILI_ROUND_S16(r3c);
            ...
            dst_data[drow3]= _XILI_ROUND_S16(r4c);
...
static
XilStatus
xili_convolve_3x3_opt_3(Xil_signed16* dst_data,
                        unsigned int  dst_sstride,
                        unsigned int  dst_pstride,
                        Xil_signed16* src_data,
                        unsigned int  src_sstride,
                        ...
                        float*        kdata)
{
    ...
    for(y=ycount; y!=0; y--) {
        ...
        inA = (float)(src_data[1]);

        temp3 = inA * k33;
        r1a1  = temp3;

        inA = (float)(src_data[2]);
        ...
        inA= (float)(src_data[srow5+1]);
    
        temp3 = inA * k31;   
        r4a1 += temp3;   

        inA= (float)(src_data[srow5+2]);
        ...
        while(1) {
            ...
            dst_data[0]= _XILI_ROUND_S16(r1a0);
            ...
            dst_data[1]= _XILI_ROUND_S16(r1a1);
            ...
            dst_data[2]= _XILI_ROUND_S16(r1a2);
            ...
            dst_data[drow1]= _XILI_ROUND_S16(r2a0);
            ...
            dst_data[drow1+1]= _XILI_ROUND_S16(r2a1);
            ...
            dst_data[drow1+2]= _XILI_ROUND_S16(r2a2);
            ...
            dst_data[drow2] = _XILI_ROUND_S16(r3a0);
            ...
            dst_data[drow2 + 1] = _XILI_ROUND_S16(r3a1);
            ...
            dst_data[drow2 + 2] = _XILI_ROUND_S16(r3a2);
            ...
            dst_data[drow3]= _XILI_ROUND_S16(r4a0);
            ...
            dst_data[drow3 + 1]= _XILI_ROUND_S16(r4a1);
            ...
            dst_data[drow3 + 2]= _XILI_ROUND_S16(r4a2);
            ...
            dst_data[0]= _XILI_ROUND_S16(r1b0);
            ...
            dst_data[1]= _XILI_ROUND_S16(r1b1);
            ...
            dst_data[2]= _XILI_ROUND_S16(r1b2);
            ...
            dst_data[drow1]= _XILI_ROUND_S16(r2b0);
            ...
            dst_data[drow1 + 1]= _XILI_ROUND_S16(r2b1);
            ...
            dst_data[drow1 + 2]= _XILI_ROUND_S16(r2b2);
            ...
            dst_data[drow2]= _XILI_ROUND_S16(r3b0);
            ...
            dst_data[drow2 + 1]= _XILI_ROUND_S16(r3b1);
            ...
            dst_data[drow2 + 2]= _XILI_ROUND_S16(r3b2);
            ...
            dst_data[drow3]= _XILI_ROUND_S16(r4b0);
            ...
            dst_data[drow3 + 1]= _XILI_ROUND_S16(r4b1);
            ...
            dst_data[drow3 + 2]= _XILI_ROUND_S16(r4b2);
            ...
            dst_data[0]= _XILI_ROUND_S16(r1c0);
            ...
            dst_data[1]= _XILI_ROUND_S16(r1c1);
            ...
            dst_data[2]= _XILI_ROUND_S16(r1c2);
            ...
            dst_data[drow1]= _XILI_ROUND_S16(r2c0);
            ...
            dst_data[drow1 + 1]= _XILI_ROUND_S16(r2c1);
            ...
            dst_data[drow1 + 2]= _XILI_ROUND_S16(r2c2);
            ...
            dst_data[drow2]= _XILI_ROUND_S16(r3c0);
            ...
            dst_data[drow2 + 1]= _XILI_ROUND_S16(r3c1);
            ...
            dst_data[drow2 + 2]= _XILI_ROUND_S16(r3c2);
            ...
            dst_data[drow3]= _XILI_ROUND_S16(r4c0);
            ...
            dst_data[drow3 + 1]= _XILI_ROUND_S16(r4c1);
            ...
            dst_data[drow3 + 2]= _XILI_ROUND_S16(r4c2);
