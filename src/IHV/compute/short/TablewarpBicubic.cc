...
//------------------------------------------------------------------------
//
//  File:	TablewarpBicubic.cc
//  Project:	XIL
//  Revision:	1.17
//  Last Mod:	10:12:27, 03/10/00
//
//  Description:
//	
//	
...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)TablewarpBicubic.cc	1.17\t00/03/10  "
...
//
static XilStatus tablewarp_bicubic(XilBoxList*  bl, TablewarpData td);
...
XilStatus
XilDeviceManagerComputeSHORT::TablewarpBicubic(XilOp*       op,
					      unsigned     ,
					      XilRoi*      roi,
					      XilBoxList*  bl)
{
    ...
    status = tablewarp_bicubic(bl, td);
...
static
XilStatus
tablewarp_bicubic(XilBoxList*  bl,
		  TablewarpData td)
{
    XilOp*    op   = td.op;
        ...
        while(rl.getNext(&x, &y, &xsize, &ysize)) {
            ...
            for(float j=dst_ystart; j<dst_yend; j++) {
                ...
                for(float i=dst_xstart; i<dst_xend;  i++) {
                    ...
                    XILI_INTERP_BICUBIC_SHORT(src_pixel,
                                             src_scanline_stride,
                                             src_pixel_stride,
                                             fracx,
                                             fracy,
