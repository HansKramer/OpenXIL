...
//	COPYRIGHT
//------------------------------------------------------------------------
#pragma ident	"@(#)BandCombine.cc	1.6\t00/03/10  "

#include "XilDeviceManagerComputeSHORT.hh"
#include "ComputeInfo.hh"

XilStatus
XilDeviceManagerComputeSHORT::BandCombine(XilOp*       op,
                                          unsigned     op_count,
                                          XilRoi*      roi,
                                          XilBoxList*  bl)
{
                ...
                for(int y=ci.ysize; y>0; y--) {
                    ...
                    for(int x=ci.xsize; x>0; x--) {
                        ...
                        for(int m=0; m<mheight; m++) {
                            ...
                            *(dest_pixel+m*dest_bstride) = _XILI_ROUND_S16(sum);
                        }
                ...
                for(int y=0; y<ci.ysize; y++) {
                    ...
                    for(int x=0; x<ci.xsize; x++) {
                        ...
                        for(int m=0; m<mheight; m++) {
                            ...
                            //
                            Xil_signed16* dest_band = dest_data +
                                y * dest_sstride +
                                x * dest_pstride;
                            ...
                            for(int k=0; k<mwidth - 1; k++) {
                                ...
                                //
                                Xil_signed16* src1_band = src1_data +
                                    y * src1_sstride +
                                    x * src1_pstride;
