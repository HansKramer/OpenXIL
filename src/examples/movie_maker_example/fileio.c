...
*----------------------------------------------------------------------*/
#ifndef lint
static	char     sccsid[] = "@(#)fileio.c	1.4\t00/03/10  ";
#endif
                        ...
                        char*          pathname)
{
    ...
    fscanf(header_file, "%s", colorspace);
    ...
    xil_set_colorspace(image, xil_colorspace_get_by_name(state, colorspace));
